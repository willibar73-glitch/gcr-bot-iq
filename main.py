...
# 8 pares principales (lunes a viernes, mercado real)
PARES_NORMAL = ["EURUSD", "EURJPY", "EURGBP", "GBPUSD", "GBPJPY", "AUDUSD", "USDCAD", "USDCHF"]
# Mismos 8 pares en versión OTC (sábado y domingo, mercado sintético de IQ Option)
PARES_OTC = ["EURUSD-OTC", "EURJPY-OTC", "EURGBP-OTC", "GBPUSD-OTC", "GBPJPY-OTC", "AUDUSD-OTC", "USDCAD-OTC", "USDCHF-OTC"]
