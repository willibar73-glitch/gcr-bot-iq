...
def refrescar_horarios():
    ...
    get_all_open_time() es algo pesado de red, por eso se llama solo
    una vez por ciclo (no una vez por par)."""
    global ALL_OPEN
    ...
    try:
        ...
        print(f" ⚠️ No se pudo refrescar horarios de mercado: {e}")
        return False
...
# Al arrancar: siempre encender el bot desde Firebase
try:
    requests.put(f"{FIREBASE_URL}/botPausa.json", json={"pausado": False, "hora": "arranque"}, timeout=5)
    print(" ✅ Estado inicial: Bot ENCENDIDO")
except: pass
